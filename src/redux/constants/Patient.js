...
export const GET_PATIENT_LOCATIONS = 'GET_PATIENT_LOCATIONS';
export const SET_PATIENT_LOCATIONS = 'SET_PATIENT_LOCATIONS';
export const SET_PATIENT_LOCATIONS_LOADING = 'SET_PATIENT_LOCATIONS_LOADING';
